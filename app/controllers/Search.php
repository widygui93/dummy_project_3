...
class Search extends Controller{
    public function index(){
		...
		$data['tutorials'] = $this->model('Search_model')->getTutorials();
		$data['total-tutorials'] = $this->model('Search_model')->getTotalTutorials();
        ...
        echo $twig->render('/search/index.html.twig',
            [
                // 'BASEURL' => BASEURL,
                // 'q' => $_POST['q']
