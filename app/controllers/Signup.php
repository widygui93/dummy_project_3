...
class Signup extends Controller {
	public function index(){
		if( $this->model('Signup_model')->isUserLogin() ) return $this->model('Signup_model')->goHome();
	...
	public function signupStudent(){
		if( $this->model('Signup_model')->isUserLogin() ) return $this->model('Signup_model')->goHome();
		if( $this->model('Signup_model')->isDataEmpty($_POST) ) return $this->model('Signup_model')->goHome();
